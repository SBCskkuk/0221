...
public class TrafficHQEditor : Editor
{
    ...
    private void OnSceneGUI()
    {
        ...
        if (lastWaypoint != null)
        {
            ...
            Plane plane = new Plane(Vector3.up, lastWaypoint.GetVisulPos());
            ...
            //구 하나 그리겠습니다.
            Handles.SphereHandleCap(0, lastWaypoint.GetVisulPos(), Quaternion.identity,
        ...
        if (lastWaypoint == null)
        {
            ...
            lastWaypoint = headquarter.GetAllWaypoints()
                .FirstOrDefault(
                    i => EditorHelper.SphereHit(i.GetVisulPos(),
